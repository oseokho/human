...
public class ServiceImpl implements Service {
	...
	{ // customer에서 custoners로 수정 21.08.06 이유림
		...
		customers.add(new Customer(no++, "2222", "2222", 20, "홍길동", 10000, false));
	...
	/**
	 * @author 오석호 (1 음료 2 담배 3 신선식품 4 과자 의 숫자반환)
	 */
	public int kind() {
		int kind = nextInt(createTextBox(new String[] {"음료", "담배", "신선식품", "과자"}),1,4);
		return kind;
	}
	...
	public void login(String id, String pw) {
		...
		if (cs != null) {
			if (cs.getId().equals(id) && cs.getPw().equals(pw)) {
